    ...
    async def join_call(
        ...
        try:
            ...
            try:
                ...
                raise AssistantErr(
                    "**💬 Lütfen grubun sesli sohbetinin etkinleştirildiğinden emin olun. Zaten etkinse, lütfen sesli sohbeti sonlandırın ve yeniden başlatın , sorun devam ederse /restart deneyin ...**"
                )
        except AlreadyJoinedError:
            raise AssistantErr(
                "**💬 Sistemler, asistanın zaten sesli sohbette olduğunu algıladı. Bu sorun genellikle 2 sorguyu birlikte yürüttüğünüzde oluşuyor , sorun devam ederse /restart deneyin ...**"
            )
        except TelegramServerError:
            raise AssistantErr(
                "**💬 Telegram bazı dahili sunucu sorunları yaşıyor, Lütfen tekrar oynatmayı deneyin , Bu sorun her seferinde devam ederse, lütfen sesli sohbetinizi sonlandırın ve yeni bir sesli sohbet başlatın...**"
            )
